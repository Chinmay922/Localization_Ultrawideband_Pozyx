...
uint16_t anchors[15] = {0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x6axx, 0x60xx, 0x6axx, 0x6axx};  // the network id of the anchors: Change the network Ids to the one for your devices
